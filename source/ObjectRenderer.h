...
public:
	...
	void paintSceneObjects(float timef, OpenGLFunctions & gl, QOpenGLShaderProgram * program, QVector3D light = QVector3D(0.0, 0.0, 0.0));

private:
	QList<AssimpScene *> m_sceneObjects;
};
